...
;;;;; org
     ...
     `(org-level-1 ((,class (:bold t :foreground ,blue :height ,(if spacemacs-theme-org-height 1.3 1.0) :background ,(when spacemacs-theme-org-highlight blue-bg)))))
     `(org-level-2 ((,class (:bold t :foreground ,aqua :height ,(if spacemacs-theme-org-height 1.2 1.0) :background ,(when spacemacs-theme-org-highlight aqua-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,green :height ,(if spacemacs-theme-org-height 1.1 1.0) :background ,(when spacemacs-theme-org-highlight green-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,yellow :background ,(when spacemacs-theme-org-highlight yellow-bg)))))
