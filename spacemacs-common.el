...
;;;;; ediff
     ...
     `(ediff-current-diff-C ((,class(:background ,org-h1-bg :foreground ,keyword))))
...
;;;;; git-timemachine
     `(git-timemachine-minibuffer-detail-face ((,class (:foreground ,keyword :bold t :background ,org-h1-bg))))
...
;;;;; magit
     ...
     `(magit-branch-current ((,class (:background ,org-h1-bg :foreground ,keyword :weight bold :box t))))
     `(magit-branch-local ((,class (:background ,org-h1-bg :foreground ,keyword :weight bold))))
...
;;;;; org
     ...
     `(org-level-1 ((,class (:bold t :foreground ,keyword :height ,(if spacemacs-theme-org-height 1.3 1.0) :background ,(when spacemacs-theme-org-highlight org-h1-bg)))))
