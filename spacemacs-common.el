...
;;;;; latex
     ...
     `(font-latex-sectioning-4-face ((,class (:weight normal :foreground ,head3 :height ,(if spacemacs-theme-org-height 1.1 1.0) :background ,(when spacemacs-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:weight normal :foreground ,head4 :background ,(when spacemacs-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     ...
     `(markdown-header-face-3 ((,class (:weight normal :foreground ,head3 :height ,(if spacemacs-theme-org-height 1.1 1.0) :background ,(when spacemacs-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:weight normal :foreground ,head4 :background ,(when spacemacs-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-level-1 ((,class (:inherit bold :weight ,(if spacemacs-theme-org-bold 'unspecified 'normal) :foreground ,head1 :height ,(if spacemacs-theme-org-height 1.3 1.0) :background ,(when spacemacs-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :weight ,(if spacemacs-theme-org-bold 'unspecified 'normal) :foreground ,head2 :height ,(if spacemacs-theme-org-height 1.2 1.0) :background ,(when spacemacs-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:weight normal :foreground ,head3 :height ,(if spacemacs-theme-org-height 1.1 1.0) :background ,(when spacemacs-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:weight normal :foreground ,head4 :background ,(when spacemacs-theme-org-highlight head4-bg)))))
