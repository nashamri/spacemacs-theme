...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((,class (:background ,comment-bg :foreground ,comment))))
   `(font-lock-negation-char-face ((,class (:foreground ,const))))
   `(font-lock-reference-face ((,class (:foreground ,const))))
   `(font-lock-constant-face ((,class (:foreground ,const))))
   `(font-lock-doc-face ((,class (:background ,comment-bg :foreground ,comment))))
...
;;;;; flycheck
   `(flycheck-error
     ((,(append '((supports :underline (:style line))) class)
      ...
      (,class (:foreground ,fg1 :background ,error :weight bold :underline t))))

   `(flycheck-warning
     ((,(append '((supports :underline (:style line))) class)
       (:underline (:style line :color ,warning)))
      (,class (:foreground ,fg1 :background ,warning :weight bold :underline t))))
...
;;;;; helm
   ...
   `(org-todo ((,class (:box (:line-width 1 :color ,fg1) :foreground ,keyword :bold t))))
   `(org-done ((,class (:box (:line-width 1 :color ,bg3) :bold t :foreground ,bg4))))
   `(org-warning ((,class (:underline t :foreground ,warning))))
   `(org-agenda-structure ((,class (:weight bold :foreground ,fg1 :box (:color ,fg1) :background ,bg3))))
   ...
   `(magit-diff-context-highlight ((,class (:background ,bg3 :foreground ,fg1))))
   ...
   `(helm-header ((,class (:foreground ,fg1 :background ,bg1 :underline nil :box nil))))
