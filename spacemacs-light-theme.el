...
;;;;; org
   ...
   `(org-level-1 ((,class (:bold t :foreground ,inf :height 1.3 :background ,(when (display-graphic-p) "#edf1ed") :overline t))))
   `(org-level-2 ((,class (:bold t :foreground ,str :height 1.2 :background ,(when (display-graphic-p) "#edf2e9")))))
   `(org-level-3 ((,class (:bold nil :foreground ,green :height 1.1 :background ,(when (display-graphic-p) "#f1f3e1")))))
   `(org-level-4 ((,class (:bold nil :foreground ,yellow :height 1.0 :background ,(when (display-graphic-p) "#f6f1e1")))))
